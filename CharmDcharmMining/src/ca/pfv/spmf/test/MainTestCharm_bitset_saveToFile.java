...
public class MainTestCharm_bitset_saveToFile {
	...
	public static void main(String [] arg) throws IOException{
		...
		csvc.convertToTransactionDataset(filesPaths[0], CsvConverter.MapValues.COMPONENT, filesPaths[1]);
...
//		algo.setShowTransactionIdentifiers(true);
		...
		csvc.convertResultsForUsers(filesPaths[2], CsvConverter.MapValues.COMPONENT, filesPaths[3]);
	}
